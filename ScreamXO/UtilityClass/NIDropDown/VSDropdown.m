...
-(void)setAdoptParentThemee:(BOOL)adoptParentTheme
{
    self.adoptParentTheme=adoptParentTheme;
}
...
-(void)setUpViews
{
   ...
   // [_tableView.layer setCornerRadius:4.0];
    ...
    _tableView.backgroundColor = [UIColor colorWithRed:0.7333 green:0.6588 blue:0.6039 alpha:1.0];
...
-(void)setupDropdownForView:(UIView *)view direction:(VSDropdown_Direction)direction withTopColor:(UIColor *)topColor bottomColor:(UIColor *)bottomColor scale:(float)scale
{
   ...
   // [_dropDownView.layer setCornerRadius:4.0];
  //  _dropDownView.layer.borderColor=[UIColor whiteColor].CGColor;
   // _dropDownView.layer.borderWidth=1.0;
