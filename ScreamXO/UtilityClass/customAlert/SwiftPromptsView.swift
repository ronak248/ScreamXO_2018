...
open class SwiftPromptsView: UIView
{
    ...
    fileprivate var promptTopBarVisibility : Bool = true
    ...
    fileprivate var promptHeaderBarColor : UIColor = UIColor(red: 0.7765, green: 0.651, blue: 0.1686, alpha: 1.0)
    fileprivate var promptBottomBarColor : UIColor = UIColor(red: 103.0/255.0, green: 77.0/255.0, blue: 12.0/255.0, alpha: 1.0)
    fileprivate var promptHeaderTxtColor : UIColor = UIColor.white
    ...
    open func enableBlurringView (_ enabler : Bool)
    { enableBlurring = enabler; backgroundType = TypeOfBackground.leveledBlurredWithTransparencyView; }
