...
static const CGFloat kYSLScrollMenuViewWidth  = 125;
...
#pragma mark -- public
-(void)selectSecondIndex
{
    _indicatorView.frame = CGRectMake(145, _scrollView.frame.size.height - kYSLIndicatorHeight, kYSLScrollMenuViewWidth, kYSLIndicatorHeight);
}
