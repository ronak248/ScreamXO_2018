...
- (void)viewDidLoad {
    ...
    [self scrollMenuViewSelectedIndex:_selectedIndex];
    if (_selectedIndex == 1)
    {
        [_menuView selectSecondIndex];
        self.currentIndex = 1;
    }
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (targetIndex >= 0 && targetIndex < self.childControllers.count) {
        ...
        if (isToNextItem) {
           ...
           // NSLog(@"%f,%ld",indicatorUpdateRatio,(long)self.currentIndex);
           // NSLog(isToNextItem ? @"Yes" : @"No");
            ...
            indicatorUpdateRatio = indicatorUpdateRatio * -1;
//NSLog(@"%f,%ld",indicatorUpdateRatio,(long)targetIndex);
          //  NSLog(isToNextItem ? @"Yes" : @"No");
           // print(indicatorUpdateRatio,isToNextItem,targetIndex)
