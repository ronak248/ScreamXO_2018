...
class NewConfigurePaymentVC: UIViewController , selectCardOrPaymentMethodDelegate
{
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        btnPay.titleLabel?.font =  UIFont(name: "Bold", size: 20)
        ...
        if isShopFlag {
            ...
            addressLbl.text = mgrItm.ItemShipingaddress
        ...
        lblitemCostStr = mgrItm.ItemPrice
        lblshippingCost.text = mgrItm.ItemShipingCost
        lblItmQty.text = mgrItm.product_qty
    ...
    @IBAction func newPayBtnClicked(_ sender: Any) {
        ...
        if paymentType == "PayPal" {
            ...
            if addressLbl.text == "" || addressLbl.text == nil{
                ...
                if isBoostFlag {
                    itemBoostByBitcoin(cardId: cardBillLbl.text!)
                } else {
            ...
            if addressLbl.text == "" || addressLbl.text == nil{
                ...
                if isBoostFlag {
                     itemBoostByAlipay(cardId: cardBillLbl.text!)
                } else {
    ...
    func  selectCardOrPaymentMethodType(methodType: String) {
        paymentType = methodType
    }
      ...
      func paymentByCard(cardId: String) {
        ...
        var params: [String: AnyObject] = ["card_id": cardType as AnyObject,
                                           ...
                                           "shipping": "" as AnyObject,
                                            "uid": usr.userId as AnyObject,
                                           "boost_type":  boost_type as AnyObject,
                                           "itemid":  self.item_id as AnyObject,
                                           "amount": self.amount as AnyObject,
                                            "type":  "OUT" as AnyObject,
                                           ]
        
        SVProgressHUD.show(withStatus: "", maskType: SVProgressHUDMaskType.clear)
        mgr.processForBoost(params as! NSMutableDictionary, successClosure: { (dic, result) -> Void in
            ...
            if result == APIResult.apiSuccess {
                ...
                params =   ["strip_response_id": (dic!.value(forKey: "result")! as! NSDictionary).value(forKey: "stripe_payment_id") as! NSString,
                                 ...
                                 "shipping": "" as AnyObject,
                                 "boost_type":  self.boost_type as AnyObject,
                                 "itemid":  self.item_id as AnyObject,
                                 "amount": self.amount as AnyObject,
                                 "no_days":  self.days as AnyObject,
                                 "no_users":  self.rechedPeople as AnyObject,
                                 "wallet_amount":  UserManager.userManager.walletMoney as AnyObject,
                ]
                print(params)
                SVProgressHUD.show(withStatus: "", maskType: SVProgressHUDMaskType.clear)
                mgr.finalBoostprocess(params as! NSMutableDictionary , successClosure: { (dic, result) -> Void in
                    SVProgressHUD.dismiss()
                    if result == APIResult.apiSuccess {
                        print(dic!)
                        print(result)
    ...
    func itemBoostByAlipay(cardId: String) {
        print(cardId)
        let mgr = APIManager.apiManager
        let usrMgr = UserManager.userManager
        var params: [String: AnyObject] = ["email_id": cardId as AnyObject,
                                           "shipping": "" as AnyObject,
                                           "uid": usr.userId as AnyObject,
                                           "boost_type":  boost_type as AnyObject,
                                           "itemid":  self.item_id as AnyObject,
        ...
        SVProgressHUD.show(withStatus: "", maskType: SVProgressHUDMaskType.clear)
        mgr.Stripealipaypayment(params as! NSMutableDictionary, successClosure: { (dic, result) -> Void in
            
            if result == APIResult.apiSuccess {
                SVProgressHUD.dismiss()
                print(dic!)
                print(result)
                params =   ["strip_response_id": (dic!.value(forKey: "result")! as! NSDictionary).value(forKey: "stripe_source_id") as! NSString,
                            "uid": usrMgr.userId as AnyObject,
                            "shipping": "" as AnyObject,
                            "boost_type":  self.boost_type as AnyObject,
                            "itemid":  self.item_id as AnyObject,
                ...
                print(params)
                SVProgressHUD.show(withStatus: "", maskType: SVProgressHUDMaskType.clear)
                mgr.StripealipaypaymentfinalBoostprocess(params as! NSMutableDictionary , successClosure: { (dic, result) -> Void in
                    SVProgressHUD.dismiss()
                    if result == APIResult.apiSuccess {
                        print(dic!)
                        print(result)
    ...
    func itemBoostByBitcoin(cardId: String) {
        print(cardId)
        let mgr = APIManager.apiManager
        let usrMgr = UserManager.userManager
        var params: [String: AnyObject] = ["email_id": cardId as AnyObject,
        ...
        SVProgressHUD.show(withStatus: "", maskType: SVProgressHUDMaskType.clear)
        mgr.Stripebitcoinpayment(params as! NSMutableDictionary, successClosure: { (dic, result) -> Void in
            ...
            if result == APIResult.apiSuccess {
                ...
                print(params)
                SVProgressHUD.show(withStatus: "", maskType: SVProgressHUDMaskType.clear)
                mgr.StripebitcoinpaymentfinalBoostprocess(params as! NSMutableDictionary , successClosure: { (dic, result) -> Void in
                    SVProgressHUD.dismiss()
                    if result == APIResult.apiSuccess {
                        print(dic!)
                        print(result)
